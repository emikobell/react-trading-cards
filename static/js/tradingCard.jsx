...
function TradingCardContainer() {
  ...
  tradingCardData.forEach((entity) => {
    cardInfo.push(
    <TradingCard
     key={entity.cardId}
     name={entity.name}
...
// ReactDOM.render(
//   <TradingCard name="Merge" skill="swimming with rainbows" imgUrl="/static/img/merge.png" />,
//   document.querySelector('#merge'),
// );

// ReactDOM.render(
//   <TradingCard name="Seedpy" skill="being delicious" imgUrl="/static/img/seedpy.jpeg" />,
